...
$(function(){
  ...
  (function(){
    ...
    function showResult(){
      ...
      var btn_yes = $('.dialog_shred').find('.btn_yes');
      var btn_no = $('.dialog_shred').find('.btn_no');
      btn_yes.click(function(){
        clearTimeout(this.timer);
        $('.selectRes').css('display', 'none');
        $('.result_yes').css('display', 'block');
