...
$(function(){
  ...
  (function(){
    ...
    var imgSources = ['loading.gif', 'bg.jpg', 'bg_main.jpg', 'bg_end.jpg', 'pic_book.png', 'btm_logo1.png', 'btm_logo2.png', 'bg_btn.png', 'index_txt.png', 'index_txt2.png', 'bg_zi.png', 'hongbao.png', 'btn_exchange.png', 'btn_online.png', 'qrcode.png', 'state1.jpg', 'state2.jpg', 'state3.jpg', 'tit_split.png', 'icon_regret.png'];
      ...
      if(this.flag){
        ...
        $("#box-btn").click(function(){
          ...
          if(_this.index < level-1){
            ...
            $('.end_mod').hide();
            var str1 = '', str2 = '', imgPath = '';
            if (_this.succNum <= 3){
              str1 = '木鸡真人';
              str2 = '问啥都“唔知”，鸡都比你聪明！滚回去重答！';
              imgPath = 'img/state1.jpg';
              $('.end_mod').eq(0).show();
            }else if(_this.succNum >= 4 && _this.succNum <= 8){
              str1 = '塞雷天师';
              str2 = '好犀利！看来你知道的姿势也是蛮多的~<br>煮碗面给你吃好不好？';
              imgPath = 'img/state2.jpg';
            }else if(_this.succNum >= 9 && _this.succNum <= 10){
              str1 = '鸿钧老祖';
              str2 = '没错！你就是小说界的老司机！<br>求你带我上昆明采野花！';
              imgPath = 'img/state3.jpg';
            }
            $('.succNum').html(_this.succNum); // 显示答对多少题
            $('.nickname').html(str1);
            $('.res_txt').html(str2);
            $(".state").find('img').attr('src',imgPath); 
          }
